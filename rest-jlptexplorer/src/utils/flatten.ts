...
export function flattenTranscriptLineFull(line: {
  ...
  return {
    ...
    transcript_line_grammar_points: transcript_line_grammar_points.map(
      (tlgp) => ({
        ...tlgp,
        grammar_points: tlgp.grammar_points
          ? flattenGrammarPoint(tlgp.grammar_points)
          : null,
      }),
    ),
  };
...
>(line: T) {
  ...
  return {
    ...
    translations: Object.fromEntries(
      translations.map((t) => [t.locale, t.translation]),
    ),
  };
}
